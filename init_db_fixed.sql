...
-- 外键约束;
ALTER TABLE user_project_roles ADD CONSTRAINT None FOREIGN KEY (id) REFERENCES users(id);;
ALTER TABLE user_project_roles ADD CONSTRAINT None FOREIGN KEY (id) REFERENCES projects(id);;
ALTER TABLE group_project_bindings ADD CONSTRAINT None FOREIGN KEY (id) REFERENCES projects(id);;
ALTER TABLE tasks ADD CONSTRAINT None FOREIGN KEY (id) REFERENCES projects(id);;
ALTER TABLE milestones ADD CONSTRAINT None FOREIGN KEY (id) REFERENCES projects(id);;
ALTER TABLE project_cost_budgets ADD CONSTRAINT None FOREIGN KEY (id) REFERENCES projects(id);;
ALTER TABLE project_cost_actuals ADD CONSTRAINT None FOREIGN KEY (id) REFERENCES projects(id);;
ALTER TABLE project_risks ADD CONSTRAINT None FOREIGN KEY (id) REFERENCES projects(id);;
ALTER TABLE project_documents ADD CONSTRAINT None FOREIGN KEY (id) REFERENCES projects(id);;
ALTER TABLE conversation_sessions ADD CONSTRAINT None FOREIGN KEY (id) REFERENCES projects(id);;
ALTER TABLE conversation_messages ADD CONSTRAINT None FOREIGN KEY (id) REFERENCES conversation_sessions(id);;
ALTER TABLE approval_workflows ADD CONSTRAINT None FOREIGN KEY (id) REFERENCES projects(id);;
